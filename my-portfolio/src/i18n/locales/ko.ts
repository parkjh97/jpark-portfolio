const ko = {
  ...
  masthead: {
    ...
    detail: [
      ...
      // "초반에는 JS와 CSS, 문자열 템플릿으로 몸으로 부딪히며 빠르게 만들어 보았고, 그 과정에서 브라우저가 어떻게 움직이고 사용자가 어디서 멈추는지를 가까이에서 배웠습니다. 이후에는 필요에 따라 React와 Next.js, Tailwind, Spring Boot 같은 도구들을 도입하며 제품을 더 단단하게 키웠습니다. 저에게 기술은 멋진 선택지가 아니라 지금의 문제를 가장 깔끔하게 푸는 수단입니다.",
